...
named as artifacts folder. The purpose of this class is to organize and manage these file paths centrally 
so they can be easily reused throughout the project without hardcoding them multiple times.
"""
@dataclass
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info("Entered the data ingestion method and conmponent")
        try:

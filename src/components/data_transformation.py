...
class DataTransformtion:
    def __init__(self):
        self.data_transformer_config = DataTransformationConfi()
    ...
    def get_data_transform_object(self):
        try:
            ...
            logging.info("Numerical columns Trnsformation is completed")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            save_object(
                file_path = self.data_transformer_config.processor_obj_file_path,
            ...
            return(
                train_arr,
                test_arr,
                self.data_transformer_config.processor_obj_file_path
            )
